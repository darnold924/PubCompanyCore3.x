...
namespace ServiceLayer
{
    public class ArticleSvc :IArticleSvc
    {
        public List<DtoArticle> GetAll()
        {
            ...
            {
                var uri = new Uri("http://localhost/WebAPI3.X/article/GetAll");
        ...
        public List<DtoArticle> GetArticlesByAuthorId(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                var uri = new Uri("http://localhost:8081/article/GetArticlesByAuthorId?id=" + id);
        ...
        public DtoArticle Find(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                var uri = new Uri("http://localhost:8081/article/Find?id=" + id);
        ...
        public void Add(DtoArticle dto)
        {
            using (var client = new HttpClient { BaseAddress = new Uri("http://localhost:8081") })
            {
                ...
                HttpResponseMessage message =
                    client.PostAsync("/article/Add", inputMessage.Content).Result;
        ...
        public void Update(DtoArticle dto)
        {
            using (var client = new HttpClient { BaseAddress = new Uri("http://localhost:8081") })
            {
                ...
                HttpResponseMessage message =
                    client.PostAsync("/article/Update", inputMessage.Content).Result;
        ...
        public void Delete(DtoId dto)
        {
            using (var client = new HttpClient { BaseAddress = new Uri("http://localhost:8081") })
            {
                ...
                HttpResponseMessage message =
                    client.PostAsync("/article/Delete", inputMessage.Content).Result;
