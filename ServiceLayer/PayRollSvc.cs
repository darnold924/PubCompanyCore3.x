...
namespace ServiceLayer
{
    public class PayRollSvc :IPayRollSvc
    {
        ...
        public DtoPayroll Find(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                var uri = new Uri("http://localhost:8081/payroll/Find?id=" + id);
        ...
        public DtoPayroll FindPayRollByAuthorId(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                var uri = new Uri("http://localhost:8081/payroll/FindPayRollByAuthorId?id=" + id);
                HttpResponseMessage getResponseMessage = client.GetAsync(uri).Result;
        ...
        public void Add(DtoPayroll dto)
        {
            using (var client = new HttpClient { BaseAddress = new Uri("http://localhost:8081") })
            {
                ...
                HttpResponseMessage message =
                    client.PostAsync("/payroll/Add", inputMessage.Content).Result;
        ...
        public void Update(DtoPayroll dto)
        {
            using (var client = new HttpClient { BaseAddress = new Uri("http://localhost:8081") })
            {
                ...
                HttpResponseMessage message =
                    client.PostAsync("/payroll/Update", inputMessage.Content).Result;
        ...
        public void Delete(DtoId dto)
        {
            using (var client = new HttpClient { BaseAddress = new Uri("http://localhost:8081") })
            {
                ...
                HttpResponseMessage message =
                    client.PostAsync("/payroll/Delete", inputMessage.Content).Result;
